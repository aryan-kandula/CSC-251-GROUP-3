...
3. Open `JavaCode_GroupProject_02_POLISHED_KandulaAryan.java`
4. Click the **Run** button at the top right, OR run in the terminal:
   ```
   javac JavaCode_GroupProject_02_POLISHED_KandulaAryan.java
   java JavaCode_GroupProject_02_POLISHED_KandulaAryan
   ```
...
| Class | Purpose |
|---|---|
| `JavaCode_GroupProject_02_POLISHED_KandulaAryan` | Main class, all menus, program entry point |
...
| File | Description |
|---|---|
| `JavaCode_GroupProject_02_POLISHED_KandulaAryan.java` | This file — polished final version |
| `JavaCode_GroupProject_02_WORKING_KandulaAryan.java` | Working draft with full development history |
